...
void Subscriber::setName(const std::string newName)
{ 
	this->name = newName; 
}
void Subscriber::setSurname(const std::string newSurn)
{	
	(*this).surname = newSurn; 
}
void Subscriber::setPatronymic(const std::string newPat)
{ 
	patronymic = newPat;
}
void Subscriber::setHomePhone(const std::string newHomePhon)
{
	homePhone = newHomePhon; 
}
void Subscriber::setMobilPhone(const std::string newMobilPhon)
{
	mobilPhone = newMobilPhon; 
}
