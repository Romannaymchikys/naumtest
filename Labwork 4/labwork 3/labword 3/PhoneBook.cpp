...
Subscriber* PhoneBook::getSubscriberArray() const { return  subscriberArray; }
Subscriber  PhoneBook::getSubArrayStatic()  const { return getSubArrayStatic();}

void PhoneBook::setIndex(const size_t newIndex) { index = newIndex; }
